    ...
    <div className='pt-20 h-screen overflow-scroll flex flex-col items-start justify-between md:px-8 px-4'>
      <form onSubmit={() => handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div>
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  ...
                  <div onClick={() => handleLecture('add', chapter.chapterId)} className='inline-flex bg-gray-100 rounded p-2 cursor-pointer mt-2'>
                    + Add Lecture
                  </div>
                </div>
              )}
          ...
          {showPopup && (
            <div className='fixed inset-0 flex items-center justify-center bg-gray-800/40 bg-opacity-50'>
