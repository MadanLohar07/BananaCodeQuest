...
const MyEnrollments = () => {
  ...
  return (
    <>
      <div className="pt-20 md:px-30 px-8">
        ...
        <table className="md:table-auto table-fixed w-full overflow-hidden border border-gray-500/20 mt-10">
          <thead className="text-gray-99 border-b border-gray-500/20 text-sm text-left max-sm:hidden ">
            <tr>
            ...
            {enrolledCourses.map((course, index) => (
              <tr key={index} className="border-b border-gray-500/20">
                ...
                <td className="px-4 py-3 max-sm:text-right">
                  <button
                    className="px-3 sm:px-5 py-1.5 s,:py-2 bg-purple-600 max-sm:text-xs text-white"
