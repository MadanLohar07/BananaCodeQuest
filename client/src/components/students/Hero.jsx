...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-purple-100 ">
      <h1 className="md:text-4xl text-2xl relative font-bold text-gray-800 max-w-3xl mx-auto">
        Empower your future with the courses designed to
        <span className="text-purple-600"> fit your choice.</span>
        <img
          src={assets.sketch}
          alt="sketch"
      ...
      <p className="md:block hidden text-gray-500 max-w-2xl mx-auto">
        ...
        supportive community to help yu achieve your personal and professional
        goals.
      </p>
